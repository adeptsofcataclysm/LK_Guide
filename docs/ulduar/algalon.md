...
![Тёмная звезда. Взрыв](/img/ulduar/algalon/Умирающая_звезда_смерть_лужа.gif)
...
![Живая звезда. Обстрел](/img/ulduar/algalon/Живая_звезда_Обстрел.gif)
...
![Светлая звезда. Уничтожение](/img/ulduar/algalon/Светлая_звезда_Уничтожение.gif)
...
![Кара небесная](/img/ulduar/algalon/Кара_небесная.gif)
...
![Суровый удар. Все в портал](/img/ulduar/algalon/Суровый_удар_портал.gif)
...
![Второй варик](/img/ulduar/algalon/Распределение_КДшек_взрывы_2вариант.png)
...
![танки меняются стаками](/img/ulduar/algalon/Стаки_фазового_удара.png)
...
![Протпал танкует](/img/ulduar/algalon/Паладин_танкует.png)
...
![Растановка на 1-ю фазу](/img/ulduar/algalon/algalon_phase1_positions.png)

РДД должны распредаться от красных луж, когда летит [кара небесная](https://www.wowhead.com/wotlk/ru/spell=6459):

![РДД доджат](/img/ulduar/algalon/Фаза1_2_доджРДД_кары_небесной.gif)

МДД должны перейти из под одной ноги босса под другую:

![МДД доджат](/img/ulduar/algalon/Фаза1_3_МДД_доджат_метеоры.gif)
...
![Появление звёзд](/img/ulduar/algalon/Фаза1_1_появление_звёзд.gif)
...
![увод звезды от мдд](/img/ulduar/algalon/Фаза1_4_смерть_звезды.gif)
...
![прилетают созвездия](/img/ulduar/algalon/Фаза1_5_прилетают_созвездия.gif)
...
![кайт созвездия](/img/ulduar/algalon/Фаза1_6_кайт_созвездия_танком.gif)

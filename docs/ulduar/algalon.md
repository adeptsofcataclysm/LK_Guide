...
1. Квестовую цепочку начинает [Диск доступа к Архиву](https://www.wowhead.com/wotlk/ru/item=45857). Чтобы его получить,
   нужно убить Железное Собрание либо в нормал-моде либо в хард-моде (убить последним Мастера Рун Молгейма или Сталелома
   соответственно).
   Квест сдаётся в Архиве, который находится сразу за Железным собранием.

> ***Замечание:** диск выпадает только один (по крайней мере нормал-мод даёт один, есть иннфа что хард-мод даёт два
диска).*
...
3. У Геолога Дорен можно взять 4 задания:
   ...
   [Печать Мимирона](https://www.wowhead.com/wotlk/ru/quest=13824) - победить Мимирона в хардмоде и
...
> ***Замечание:** Алгалон сдаёт первый [фазовый удар](https://www.wowhead.com/wotlk/ru/spell=64412) спустя примерно 25
...
Первый важный момент: рейд должен быть максимально готов принять [взрыв](https://www.wowhead.com/wotlk/ru/spell=65108).
...
![Тёмная звезда. Взрыв](/img/ulduar/algalon/Умирающая звезда_смерть и лужа.gif)
...
![Живая звезда. Обстрел](/img/ulduar/algalon/Живая звезда. Обстрел.gif)
...
![Светлая звезда. Уничтожение](/img/ulduar/algalon/Светлая звезда. Уничтожение.gif)
...
![Кара небесная](/img/ulduar/algalon/Кара небесная.gif)
...
дебафф [Черная дыра](https://www.wowhead.com/wotlk/ru/spell=62169). Каждую секунду пока игрок находистя в том мире ему
наносится от 1500 до 2000 урона от <span  className="dmg-arcane">тайной</span> магии.

![Суровый удар. Все в портал](/img/ulduar/algalon/Суровый удар. Все в портал.gif)
...
звёзды, которые будут всегда спавниться по 3 штуки за раз. А если их не убивать, не заводить в чёрные порталы, то они
просто шальными [чародейскими обстрелами](https://www.wowhead.com/wotlk/ru/spell=64607) могут например убить танка или
хила. Но это половина беды! Если светлая звезда каснётся портала, то он пропадёт вместе со звездой, и рейд может не
...
> ***Замечание:** чисто игромеханически, это значит что Алгалон не должен во время произнесения заклинания остаться
...
Можно дать убить себя [суровым ударом](https://www.wowhead.com/wotlk/ru/spell=64584) но выжить. Такие вещи
...
![табличка на суровый удар](/img/ulduar/algalon/Суровый удар. Табличка.png)
...
![большой урон](/img/ulduar/algalon/Урон по танку в сравнении2.png)
...
Бруталусе. Вроде бы и можно с ним что-то придумать, а по факту нужно обходится в два танка.
...
Также нужно не забыт про баффы на танков. Речь не про [баф на стамину](https://www.wowhead.com/wotlk/ru/spell=48162) и
...
![Диаграмма взрывов звёзд](/img/ulduar/algalon/Диаграмма взрывов звёзд.png)
...
Под каждый [взрыв](https://www.wowhead.com/wotlk/ru/spell=65108) нужно прожать что-то паладинское.
...
![Распределяем КДшки](/img/ulduar/algalon/Распределение КДшек на взрывы.png)
...
![Второй варик](/img/ulduar/algalon/Распределение КДшек на взрывы_2вариант.png)
...
![танки меняются стаками](/img/ulduar/algalon/Стаки фазового удара.png)
...
Если ещё не поняли, то КДшки нужно сдавать **НЕ ОДНОВРЕМЕННО**, а одну за дргуой. Мне кажется, на всё время танкования
...
КДшки на восполнение маны нужно сдавать и в начале боя, чтобы они откатились по ходу энкаунтера. Бой длится 6 мин., тот
...
![Растановка на 1-ю фазу](/img/ulduar/algalon/Алгалон. Растановка на 1-ю фазу.png)

РДД должны распредаться от красных луж, когда летит [кара небесная](https://www.wowhead.com/wotlk/ru/spell=6459):

![РДД доджат](/img/ulduar/algalon/Фаза1_2_доджРДД кары небесной.gif)

МДД должны перейти из под одной ноги босса под другую:

![МДД доджат](/img/ulduar/algalon/Фаза1_3_МДД доджат метеоры.gif)
...
![Появление звёзд](/img/ulduar/algalon/Фаза1_1_появление звёзд.gif)
...
![увод звезды от мдд](/img/ulduar/algalon/Фаза1_4_смерть звезды.gif)

До 1:30 нужно убить столько тёмныз звёзд, сколько было задумано. Две, три, а может быть и все четыре. Чем больше убивать
...
На 60-й с. боя прилетают 3 живых созведия и начинают стрелять по рейду. Они спускаются как правило в центр круглой
...
![прилетают созвездия](/img/ulduar/algalon/Фаза1_5_прилетают созвездия.gif)
...
![кайт созвездия](/img/ulduar/algalon/Фаза1_6_кайт созвездия танком.gif)
...
Пропадают все тёмные и светлые звёзды и больше не появляются. Пропадают все существующие чёрные дыры и появляется 4 дыры
вокруг босса. Расстановка не меняется (я не вижу смысла. где-то писали в гайдах, что нужно босса поставить в центре
арены но честно я не вижу смысла).

![переход](/img/ulduar/algalon/Фаза2_переход.gif)
...
![чудики](/img/ulduar/algalon/Фаза2_2_чудики.gif)

...
восстанавливают своё здоровье, бафаются и получают новые способности. Порядок убийства мобов и определяяет сложность
...
Важно отметить, что не имеет значения кого вы убиваете первым для какого-то мода. Например, вы хотите сделать изи-мод.
...
Если вы думаете, что можно всех убить одновременно, то не получится. Как на близнецах в СВП после смерти одного босса
остальные полностью восстанавливают своё здоровье.

> ***Замечание:** это не значит, что нельзя кливать (или накладывать дотки на всех генералов). Если ваш класс получает
буст по урону в **соло таргет** если как-то дамажите других боссов, то вам нужно это делать. Максимизируйте урон в одну
цель.*
...
Сейчас пойдёт описание всех скилов, вне зависимости от сложности. Я приведу урон от способностей без учёта
...
![Буревестник](/img/ulduar/assembly/буревестник-брундир.jpg)
...
- [Цепная молния](https://www.wowhead.com/wotlk/ru/spell=63479) **(2 с.)**: применяет в слючайную цель. Наносит её от
...
> ***Замечание:** цепнуху можно и НУЖНО сбивать, более того на неё действует эффекты увеличения времени заклинания (
...
- [Перегрузка](https://www.wowhead.com/wotlk/ru/spell=63481) **(заряжается 6 с.)**: Брундир начинает заряжаться энергией
  для мощного АОЕ. В это время он никуда не двигается и никого небьёт. После зарядки всем игрокам в радиусе 20 ярдов
  наносится 25 000 урона от сил <span className="dmg-nature">природы</span> и отбрасывает их.

![vshuh](/img/ulduar/assembly/Буревестник_пеерзагрузка.gif)

> ***Замечание:** а вот данный каст нельзя сбить. Также во время
прочтения [перегрузки](https://www.wowhead.com/wotlk/ru/spell=63481) босс становится невосприимчевым к оглушению.*
...
- [Вихрь молнии](https://www.wowhead.com/wotlk/ru/spell=63483) **(мгновенный каст ---> потоковое 5 с.)**: босс начинает
  крутится на месте, бросая в случайные цели 5 шаров молнии каждую секунду. Шары наносят от 5655 до 6345 урона от
  сил <span className="dmg-nature">природы</span>.

![vshuh2](/img/ulduar/assembly/Беревестник_крутилка.gif)
...
- [Светящиеся придатки](https://www.wowhead.com/wotlk/ru/spell=63486) **(мгновенное)**: из боссы вырастают...
...
![tentakly](/img/ulduar/assembly/Буревестник_тинтакли.gif)
...
![моща](/img/ulduar/assembly/Руна мощи.png)

- [Рунический щит](https://www.wowhead.com/wotlk/ru/spell=63489) **(1,5 с.)**: мастер рун окружает себя красным щитом на
...
![Щит](/img/ulduar/assembly/Рунический щит.png)
...
![smert](/img/ulduar/assembly/Руна смерти.png)
...
- [Руна призыва](https://www.wowhead.com/wotlk/ru/spell=62273) **(2 с.)**: под случайным игроком чертит небольшую
  ...
  применяет [вспышку молний](https://www.wowhead.com/wotlk/ru/spell=63491). Мелкий электрический пяздюк взрывется,
...
> ***Замечание:** элементали попрут не сразу, через секунды 2 после начерчения руны. В общем у рейда будет достаточно
...
![wawawwawawawa](/img/ulduar/assembly/Руна призыва.gif)
...
![Falcon Punch](/img/ulduar/assembly/Сталелом_ударище.gif)

- [Высокое напряжение](https://www.wowhead.com/wotlk/ru/spell=63498) **(дамажащая аура)**: наносит 3000 урона от
  сил <span className="dmg-nature">природы</span> всем игрокам раз в 3 с. Хз какой радиус, но достанет до всех, где бы вы
  ни были.
...
> ***Замечание:** [статический сбой](https://www.wowhead.com/wotlk/ru/spell=63494) не прилетит в того, на ком уже
существует дебафф от предыдущего [статического сбой](https://www.wowhead.com/wotlk/ru/spell=63494).*

![shar](/img/ulduar/assembly/Сталелом_летящийшар.gif)

<u>После смерти двух генералов превращается во второго босса БВЛа и Каззака. Смерть ЛЮБОГО игрока отлечивает босса на
40%, при этом Сталелом кидает дебафф в танка, убивающий того через 30 с.</u>
...
- [Электрический разряд](https://www.wowhead.com/wotlk/ru/spell=61902) **(бафф и отхил)**: смерть любого игрока отхилит
...
> ***Замечание:** от [переполняющей энергии](https://www.wowhead.com/wotlk/spell=61888) нельзя спастись,
...
танку ещё более больнее чересчур рискованно. Да, лужа [руна смерти](https://www.wowhead.com/wotlk/ru/spell=63490) тоже
...
Но это не самый лёгкий вариант. Легче всего первым убить Молгейма, а Буревестника вторым. Так вторая фаза будет проще.
...
КЛИВАТЬ БОССОВ БЕСПОЛЕЗНО! Один фиг генералы отхиливаются на фул при убийстве одного из них. Ещё следует сказать, что
...
которой человек получает [Ключ доступа к Священному Планетарию](https://www.wowhead.com/wotlk/ru/item=45798), который
открывает закрытую секцию Ульдуара. В Планетарии рейд может сразится с "настоящим" финальным боссом Ульдуара, Алгалоном
Наблюдателем. Подробнее почитать об этой цепочке написано в начале страницы босса **Алгалон Наблюдатель**.
...
подальше, чтобы [перегрузка](https://www.wowhead.com/wotlk/ru/spell=63481) этого железного дварфа не до бОльшей части
рейда.
...
В нанесении урона будут помогать [руны мощи](https://www.wowhead.com/ru/spell=61973). Танкам важно под каждый
...
![планизимод](/img/ulduar/assembly/изимод_план1.png)
...
В любом случае никто не должен умереть от [перегрузки](https://www.wowhead.com/wotlk/ru/spell=63481) Буревестника.
...
каст [энергитического удара](https://www.wowhead.com/wotlk/ru/spell=63493), то следует допрохилить МТ до фула. После
...
![Бам бл!](/img/ulduar/assembly/Fusion punch.gif)
...
Если рейд хочет сделать хард-мод, то все ДД пусть бьют Буревестника. Танки стоят так-же, как на изи- или нормал-моде.
...
![111](/img/ulduar/assembly/Tres.png)
![222](/img/ulduar/assembly/Duo.png)
![333](/img/ulduar/assembly/Unos.png)
...
![111](/img/ulduar/assembly/tres_ok.png)
![222](/img/ulduar/assembly/Duo_ok.png)
![333](/img/ulduar/assembly/Unos_ok.png)

Люди назначенные на Буревестнике теперь должны контролить ещё
...
Порядок убийтсва: Сталелом ---> Буревестник Брундир ---> Мастер рун Молгейм. Крайне не советую убивать сначала
...
спавна [руны мощи](https://www.wowhead.com/ru/spell=61973) следует всем отойти от неё, взять спред по всей комнате,
подождать спавн [руны смерти](https://www.wowhead.com/wotlk/ru/spell=63490), после чего уже безопасно подвести
...
спавнящихся [рун призыва](https://www.wowhead.com/wotlk/ru/spell=62273), и заливать электрических элемчиков пока они не
...
несколько [взрывов](https://www.wowhead.com/wotlk/ru/spell=63491) от маленьких шихидов положат часть рейда.

### Хард-мод. Фаза 2 и 3. ###

Мы убили Буревестника, теперь у Мастер рун появляется новая
руна, [руна смерти](https://www.wowhead.com/wotlk/ru/spell=63490). А здоровяк научился
кидать [статический сбой](https://www.wowhead.com/wotlk/ru/spell=63494). Готовьтесь, хилы!
...
спавна [руны мощи](https://www.wowhead.com/ru/spell=61973) следует всем отойти от неё, взять спред по всей комнате,
подождать спавн [руны смерти](https://www.wowhead.com/wotlk/ru/spell=63490), после чего уже безопасно подвести Мастера
...
Сталелом [статическим сбоя](https://www.wowhead.com/wotlk/ru/spell=63494) в первую очередь выбирается среди целей в
...
ловить [статический сбой](https://www.wowhead.com/wotlk/ru/spell=63494). Они должны стоять вдалеке распреданно, по ним
по очереди будет летать эта абилка. Из-за [статического сбоя](https://www.wowhead.com/wotlk/ru/spell=63494) МТ и ОТ
...
Примерно так проходит вторая фаза. Настало время поговорить о переходе на самую жёсткую, третью. Возрадуйтесь!
Свистопляски с [рунами мощи](https://www.wowhead.com/ru/spell=61973)
и [рунами смерти](https://www.wowhead.com/wotlk/ru/spell=63490) подошли к концу. Боолее того, рейд получает возможность
...
осложняет ещё тот факт, что от каждой смерти игрока босс отхиливается на 40% от своего запаса здоровья и получает
стак [электрического разряда](https://www.wowhead.com/wotlk/ru/spell=61902), повышающего урон на 25%. Эти механики
првращают третью фазу хард-мода в жёсткую гонку ДПСа. Танки будут умирать
от [оплавления](https://www.wowhead.com/wotlk/ru/spell=61889) после
спадения [переполняющей энергии](https://www.wowhead.com/wotlk/spell=61888), и это должны быть единственные смерти на
...
конец таймера нужно уйти из рейда. Взрыв [оплавления](https://www.wowhead.com/wotlk/ru/spell=61889) в убьёт всех, ибо
продамажит на 45 000 урона.
...
выживает ли два танка от урона Сталелома. Каких бы топ ДД и топ Хилов не было в реде, недоодетые танки просто не

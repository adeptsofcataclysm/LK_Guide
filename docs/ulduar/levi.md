---
sidebar_position: 3
title: Огненный левиафан
description: Утюг
---

# Огненный левиафан

![Машына](/img/ulduar/levi/flameleviathan1.jpg)
...
Лефиафаном рейду нужно прорваться сквозь многочисленный треш, после убийства которого выйдет сам босс.

## Кратко про энкаунтер

Энкаунтер условно разделяется на 2 части. Первая: рейд на машинах должен проехать через Железный двор, убивая весь треш
на своём пути. Попутно нужно разрушать башни, из которых появляются новые мобы и уничтожать Башни Хранителей. Вторая
часть - это бой с самим Огненным Левиафаном. Катаемся на машинках и нажимаем кнопочки.
...
урон по Левиафану, также могут катапультировать игроков на крышу босса. Наконец, <span className="dmg-light">
осадные машины</span> - "танки", способные неплохо водить босса своими "рывками", прерывать самые неприятные атаки
Левиафана и временно защищать себя барьером.

Игрокам доступно 5 машин каждого типа в рейде на 25 игроков. Выходит, только 15 человек будут кататься? Нет, потому что
...
:::info
У разрушителя и осадной машины по два места, для водителя и пассажира. У чоппера тоже два места, но
скилы есть только у водителя (пустое место для того, чтоб быстро перевозить игроков по полю боя, а то персонаж очень
легко умирает от босса и аддов). Итого в рейде на 25 человек 10 из них садятся в 5 разрушителей, ещё 10 человек в 5
осадных машин, и оставшиеся 5 пойдут кататься на мотоциклах. Никто не останется без дела.
:::

Следует отметить, что здоровье и исходящий урон модифицируется. У всех машин есть **базовое здоровье** и **базовый урон
...
:::info
Здоровье машины зависит только от гира водителя, но урон от способностей у каждого места свой, зависящий от гира члена
экипажа занявшее место. Поэтому рекомендуют лучше загиренных челов садить на места водителей, если есть такая
возможность.
:::
...
2. Слоты под кольцо1 и кольцо2 считаются как отдельные слоты (у аксессуаров также).
3. Качество предметов также важно. Синяя вещь эквивалентна фиолетовой вещи, но на 13 уровней ниже. Зелёная вещь
   эквивалентна фиолетовой вещи, но на 26 уровней ниже.
4. Если слот пустой, то он эквивалентен слоту с эпигом 0 Ilvl.
...
6. Значение Ilvl в вещах берутся в расчёт только при посадке на транспортное место. Чтоб поменять статы, нужно слезть с
   машины и сесть заново.

:::info
Я не нашёл объемлющей информации по поводу данного коэффициента. В одном месте прочитал, что он
...
|                                        |                                                                                                                                                                                                                                                                    |
|:--------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| ![motik](/img/ulduar/levi/Чоппер2.jpg) | Очень быстрая машина, в которой может находится <span className="dmg-fire"> Водитель </span> и один <span className="dmg-nature">"Заяц"</span>. Основная роль - поддержка (замедление, перевозка игроков) и немного ДД. <br/> У чоппера 504 000 базового здоровья. |
...
![spos](/img/ulduar/levi/Чопперскилы.jpg)

#### [Ультразвуковой рожок](https://www.wowhead.com/wotlk/ru/spell=62974)

Расходует **20 энергии**. Выпускает звуковую волну перед собой, наносящую от 6300 до 
7700 <span className="dmg-phis">физического</span> урона.

![Rozok](https://www.wowhcb.ru/adepts/ulduar/levi/sonic-horn.gif)

#### [Мазут](https://www.wowhead.com/wotlk/ru/spell=62286)

Расходует **0 энергии**. Чоппер выплёскивает немного мазута позади себя, создавая лужу из этой жижи радиусом 9 ярдов. 
В луже все враги замедляются на 75%. Мазут существует 45 с. КД способности 15 с.

![mazut](https://www.wowhcb.ru/adepts/ulduar/levi/tar2.gif)

#### [Повышение скорости](https://www.wowhead.com/wotlk/ru/spell=62299)

Расходует **50 энергии**. Подрубается "нитро", скорость чоппера увеличивается на 100% на 5 с.

![Speeeed](https://www.wowhcb.ru/adepts/ulduar/levi/speed-boost.gif)

#### [Набор первой помощи](https://www.wowhead.com/wotlk/ru/spell=64660)

Расходует **0 энергии**. Излечивает пассажира полностью (точнее, 4 тика восстановления 30% здоровья пассажира). 
КД аптечки 60 с.

![Aptechka](https://www.wowhcb.ru/adepts/ulduar/levi/first-aid-kit.gif)
...
|                                             |                                                                                                                                                                                                                                                                                                                                                                                    |
|:-------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| ![motik](/img/ulduar/levi/Разрушитель2.jpg) | Самая дамажашая машина, в которой может находится <span className="dmg-fire"> водитель </span> и один <span className="sunlight">пассажир</span>. Основная роль - наносить урон Левиафану и катапультировать десант на его крышу, чтоб убить турелли и вывзвать [перегрузку системы](https://www.wowhead.com/wotlk/ru/spell=62475). <br/> У разрушителя 630 000 базового здоровья. |

Ресурс машины - <span className="dmg-ice">колчедан</span>. Его добывает пассажир. Максимум 50 колчедана.

**Водитель** управляет машиной, может кидаться огненными валунами и бочками с колчеданом, таранить и отбрасывать
всякую мелочь перед собой, запускать пассажира на крышу босса. Панель способностей водителя выглядит так:

![скилы шефа](/img/ulduar/levi/Разрушитель_водила_скилы.jpg)

#### 1 [Бросок валуна](https://www.wowhead.com/wotlk/ru/spell=62306)
Расходует **0 колчедана**. Бросает огненный валун, который наносит от 27 000 до 30 000 урона 
от <span className="dmg-fire">огня </span> в радиусе 8 ярдов. Дальность катапульты от 10 до 70 ярдов. Поджигает 
лужи из [мазута](https://www.wowhead.com/wotlk/ru/spell=62286). КД способности ??

![Лови ядро!](https://www.wowhcb.ru/adepts/ulduar/levi/hurl-boulder.gif)

#### 2 [Бросок бочки колчедана](https://www.wowhead.com/wotlk/ru/spell=62490)
Расходует **5 колчедана**. Бросает бочку горючей синей жижи, которая 
накладывает <span className="dmg-fire">огненную</span> доту на всех врагов в радиусе 8 ярдов в месте приземления. 
Дота наносит 12 000 урона раз в секунду в течении 10 с., стакается до 10-и раз.

![Жижа в лицо](https://www.wowhcb.ru/adepts/ulduar/levi/hurl-pyrite-barrel.gif)

#### 3 [Таран](https://www.wowhead.com/wotlk/ru/spell=62308)
Расходует **0 колчедана**. Разрушитель таранит врагов, нанося от 19 000 до 
21 000 <span className="dmg-phis">физического</span> урона по мобам и отталкивает их. Наносит от 2160 до 2640 
осадного урона строением. КД способности 4 с. Дальность 10 ярдов.

![Таран](https://www.wowhcb.ru/adepts/ulduar/levi/ram2.gif)

#### 6 [Выброс пассажира](https://www.wowhead.com/wotlk/ru/spell=62324)
Расходует **0 колчедана**. Запускает игрока, который сел в катапульту
через [кнопку](https://www.wowhead.com/wotlk/ru/spell=64414). КД способности 30 с. Действие **не мгновенное**, каст 1 с. 
Кнопку невозможно прожать, если в ковше катапульты никто не сидит.

![Пущай полетает](https://www.wowhcb.ru/adepts/ulduar/levi/throw-passenger.gif)


***Пассажир*** использует мортиру для огневой поддержки против боссов и мобов, применяет ракеты ПВО для сбития летающих
бочек с колчеданом, захватывает эти бочки крюком для пополнения боезапаса водителя, может подлить колчедан в двигатель и
увеличить скорость разрушителя, и наконец пассажир не проч поместить себя в ковш катапульты для десантирования на
босса. Ресурс тот же, колчедан общий и для водителя и для пассажира. Панель способностей пассажира выглядит так:

![Кнопки пассажира](/img/ulduar/levi/Разрушитель_пассажир_скилы.jpg)

#### 1 [Пушечный залп](https://www.wowhead.com/wotlk/ru/spell=62634)
Расходует **0 колчедана**. Стреляет из пушки огненным снарядом, наносящим урон 
от <span className="dmg-fire">огня</span> в радиусе 11 ярдов от места приземления. Урон противнику наносится тем больше, 
чем ближе он находится к центру взрыва. Если чуть зацепить врага, то нанесётся около 5000 урона. Прямое попадание 
нанесёт около 120 000 урона. Дальность полёта снаряда от 10 до 50 ярдов. 

![пушка](https://www.wowhcb.ru/adepts/ulduar/levi/mortar.gif)

#### 2 [Противовоздушная ракета](https://www.wowhead.com/wotlk/ru/spell=64979)
Расходует **0 колчедана**. Стреляет из пушки ракетами, которыми можно сбить летающие бочки с колчеданом. Наносит 
около 10 000(???) урона от <span className="dmg-fire">огня</span>. 

![pvo](https://www.wowhcb.ru/adepts/ulduar/levi/anti-air-rocket2.gif)

#### 3 [Притягивание ящиков](https://www.wowhead.com/wotlk/ru/spell=67387)
Расходует **0 колчедана**. Захватывает выбранную бочку с колчеданом, тянет к разрушителю и заправляет в бак. 
Добавляет 25 единиц колчедана. Дальность захвата 50 ярдов.

![ящики](https://www.wowhcb.ru/adepts/ulduar/levi/grab-crate.gif)

#### 4 [Повышенная скорость](https://www.wowhead.com/wotlk/ru/spell=62471)
Расходует **25 колчедана**. Заливает часть жидкого колчедана в двигатель, увеличивая скорость разрушителя 
на 100% на 20 с. 

#### 6 [Загрузка в катапульту](https://www.wowhead.com/wotlk/ru/spell=64414)
Расходует **0 колчедана**. Помещает персонажа в ковш катапульты, чтоб быть потом катапультированным 
способностью [выброс пассажира](https://www.wowhead.com/wotlk/ru/spell=62324). Во время пребывания в ковше невозможно 
пользоваться способностями пассажира. 

![Петрооович!](https://www.wowhcb.ru/adepts/ulduar/levi/load-into-catapult.gif)

:::caution
Катапульта, которой управляет водитель разрушителя, может двигаться вверх-вниз, но не влево-вправо.
Попытка повернуть прицел приведёт к повороту всей машины, а разрушитель поворачивается медленно (как и осадная 
машина, впрочем). Это не только непривычно, но и стесняет ведение огня. Особенно это чувствуется на хардмоде, когда нужно
...
![водиласкилы](/img/ulduar/levi/ОсМаш_водила_скилы.jpg)

#### 1 [Таран](https://www.wowhead.com/wotlk/ru/spell=62345)
Расходует **40 пара**. Работает также, как [таран](https://www.wowhead.com/wotlk/ru/spell=62308) разрушителя, но 
немного сильнее. Наносит от 22 501 до 27 501 ед. <span className="dmg-phis">физического</span> урона противникам и 
отталкивает их назад. Также наносит 2850 to 3150 ед. осадного урона строениям. Дальность 10 ярдов. 

![таран](https://www.wowhcb.ru/adepts/ulduar/levi/ram.gif)

#### 2 [Электрошок](https://www.wowhead.com/wotlk/ru/spell=62522)
Расходует **38 пара**. Бьёт электрическим разрядом всех впереди осадной машины. Наносит около 8500 урона от 
сил <span className="dmg-nature">природы</span> и прерывает чтение заклинания. КД способности 10 с. Дальность 25 ярдов.

![шокер](https://www.wowhcb.ru/adepts/ulduar/levi/electroshock.gif)

#### 3 [Паровое ускорение](https://www.wowhead.com/wotlk/ru/spell=62346)
Расходует **40 пара**. Машина совершает рывок в направлении движения, раскидывая всех врагов на своём пути на своём 
пути. При этом врагам наносится около 28 000 <span className="dmg-phis">физического</span> урона. Также наносит около 
2000 осадного урона строениям. КД способности 15 с.

![вперде](https://www.wowhcb.ru/adepts/ulduar/levi/steam-rush.gif)                                                                                                              
...
![Пассажирщитовки](/img/ulduar/levi/ОсМаш_пассажир_скилы.jpg)

#### 1 [Противовоздушная ракета](https://www.wowhead.com/wotlk/ru/spell=62359)
Расходует **10 пара**. Стреляет из пушки ракетами, которыми можно сбить летающие бочки с колчеданом. Наносит 
около 10 000(???) урона от <span className="dmg-fire">огня</span>.

![PVO](https://www.wowhcb.ru/adepts/ulduar/levi/anti-air-rocket.gif)

#### 2 [Выстрел из пушки](https://www.wowhead.com/wotlk/ru/spell=62358)
Расходует **20 пара**. Стреляет пушечным ядром в наведённое место, нанося повреждения всем в радиусе 8 ярдов. При 
прямом попадании наносит около 72 000 <span className="dmg-phis">физического</span> урона по врагам, и ещё 2500 осадного 
урона по строениям. Чем дальше враг от центра взрыва, тем меньше урон. Дальность полёта снаряда от 10 до 70 ярдов.

![выстрел из пульки](https://www.wowhcb.ru/adepts/ulduar/levi/fire-cannon.gif)

#### 3 [Генератор защиты](https://www.wowhead.com/wotlk/ru/spell=64677)
Расходует **0 пара**. Создаёт защитный купол вокруг своей осадной машины, поглощающий весь урон в течении 5 с. КД 
способности 60 с.

![SHeat](https://www.wowhcb.ru/adepts/ulduar/levi/shield-generator.gif)
...
2. **Бранн Бронзобород** запускает обычный режим ***Левиафан+0***. После этого нельзя будет включить хардмод у Хранителя
   знаний Норганнона.
...
фиг, перед боссом существуют две круглые платформы, которые позволят полностью отремонтировать машину. Можно чинить
сколько угодно раз.

Для обычного режима (Левиафан без башен, или же левиафан+0) нужно уничтожить все башни хранителей.

![Mapaart](/img/ulduar/levi/КартаБашен.jpg)

## Битва с Огненным Левиафаном
...
> ***Замечание:** скорее всего здоровье туррели также получают прибавку к здоровью в хардмоде из-за башни.*
...
### Задачи каждого места на машинах

#### <span className="sunlight">Чоппер</span>

Не самая ответственная и сложная роль. Машинка очень быстрая,
...
#### <span className="dmg-ice">Разрушитель</span> **(водитель)**

Cамая ответственная роль. От данной позиции ожидают самый высокий урон, наносить который на данном месте непросто. Самая
главная задача - настакивать дотку, [бросая бочки колчедана](https://www.wowhead.com/wotlk/ru/spell=62490) и
поддерживать её. Напомню: каждый бросок бочки стоит 5 колчедана. Максимум можно наложить 10 стаков дебаффа, тикает 10 
секунд. Нельзя допустить, чтоб стаки спали, но и тратить бочки колчедана на спам не нужно, никаких бочек не хватит. Пока
тикает дотка, нужно пару тройку раз [бросить валуны](https://www.wowhead.com/wotlk/ru/spell=62306). Вторая задача - 
кайтить левиафана, если он нацелился на разрушитель. Если босс нацелился на вас, то нужно попросить пассажира применить
...
#### <span className="dmg-ice">Разрушитель</span> **(пассажир)**: 
Ответственности примерно столько же, сколько и на
...
#### <span className="dmg-ice">Разрушитель</span> **(катапультирование на крышу)**: 
По команде, названные разрушители (
...
#### Осадная машина (водитель)
Умеренно сложная роль. Водитель должен быть рядом с боссом. Первоочередная задача - следить за кастами 
[огненного дыхания](https://www.wowhead.com/wotlk/ru/spell=62396) и сбивать их своим 
[электрошоком](https://www.wowhead.com/wotlk/ru/spell=62522). Рендж способности (25 ярдов) позволяет не тыкаться
...
развернуться (повторяю, разворачивается осадная машина **НЕ МГНОВЕННО**) и дать ~~по съёбам~~ 
[паровое ускорение](https://www.wowhead.com/wotlk/ru/spell=62346).

#### Осадная машина (пассажир)
Имеет при себе весьма мощное орудие для
...
- [Башня огня](https://www.wowhead.com/wotlk/ru/spell=65075): учеличивает здоровье босса на 40%, увеличивает наносимы
  урон от <span className="dmg-fire">огня</span> на 50%. Спустя некоторое время после пула босса у ворот (откуда
  Левиафан
...
|:-----------------------------------------------------------------:|:----------------------------------------------------------------:|:---------------------------------------------------------------------:|:-------------------------------------------------------------------:|
| ![1111](https://www.wowhcb.ru/adepts/ulduar/levi/hodirs-fury.gif) | ![333](https://www.wowhcb.ru/adepts/ulduar/levi/freyas-ward.gif) | ![222](https://www.wowhcb.ru/adepts/ulduar/levi/mimirons-inferno.gif) | ![444](https://www.wowhcb.ru/adepts/ulduar/levi/thorims-hammer.gif) |

:::info
Здоровье увеличивается мультипликативно. **Левиафан+4** станет жирнее на 284%!
:::

:::info
Порядок включения способностей башен строгий. Я как раз поставил описания каждой из башен в такой последовательности.
:::
...
гира. [Отключение системы](https://www.wowhead.com/wotlk/ru/spell=62475) стало сложнее делать из-за мансов. Придётся
попотеть

...
Мимирон - хранитель который отвечает за практически все изобретения титанидов. Покровителем является Норганон, титан
...
Локен под влиянием Йогг-Саррона изменил матрицу создания помошников-титанилов в Кузне Воли. Мимирон первым заподозрил
...
Почти все защитные механимы Ульдуара (в том числе Огненный левиафан И Разрушитель XT-200) были сконструированы
...
мини-левиафаном, на второй Мимрон забирается в туррель по центру комнаты, на третьей садится в шарообразный вертолёт и
летает над головами игроков. На четвёртой живых машин в гараже не остаётся, и гном в панике собирает из разбитых
изобретений свой щедевр! Получается высокий робот на гусеницах от левиафана, туррелью вместо туловища и
вертолётом-головой.
...
![леви](/img/ulduar/mimiron/Маленький леви.jpg)
...
- [Мины ближнего действия](https://www.wowhead.com/wotlk/ru/spell=63027) **(мгновенное)**: танк разбрасывает мины по
  ...
  огня</span> всем в радиусе 3 ярдов от мины. Применяте примерно каждые 35 с.

> ***Замечание:** старые мины [взрываются](https://www.wowhead.com/wotlk/ru/spell=63009), когда спавнятся новые. Также
мины не образуют прям ловушку из взрывчатки. Можно будет спокойно выбежать практически в любом направлении, но
аккуратно.*

![мины](/img/ulduar/mimiron/Мины.gif)
...
![напалм в лицо](/img/ulduar/mimiron/Заряд напалма.gif)
...
![прожарка](/img/ulduar/mimiron/Взрыв плазмы.gif)

- [Шоковый удар](https://www.wowhead.com/wotlk/ru/spell=63631) **(4 с.)**: левиафан накапливает электрическую энергию и
  взрывается, нанося всем в ражиусе 15 ярдов 100 000 урона от сил <span className="dmg-nature">природы</span>. Применяет
  примерно каждые 35 с.

![шоковый удар](/img/ulduar/mimiron/Шоковый удар.gif)

> ***Замечание:** левиафан может применять способности одновременно. Например,
...
агрорадиус у Мимирона весьма маленький. После запула идёт непродолжительная сценка, где малеьнкий хранитель жалуется на
то, что его отвлекли. После чего садится в машину и начинает бой. Можно начать танковать прямо на месте, никуда левиафан
двигать не нужно на нормал моде.

Можно сказать, что первая фаза это гонка ДПСа, потом скажу почему (спойлер:
из-за [взрыва плазмы](https://www.wowhead.com/wotlk/ru/spell=62997)).

Всем Хилам и РДД следует быть дальше чем 15 ярдов от босса, чтоб на голову не
...
> ***Замечание:** обычно [взрыв плазмы](https://www.wowhead.com/wotlk/ru/spell=62997) приходится на время свистоплясок
с [шоковоым ударом](https://www.wowhead.com/wotlk/ru/spell=63631).*
...
![Туррель](/img/ulduar/mimiron/Туррель.jpg)
...
![жара волны](/img/ulduar/mimiron/Волна жара.gif)
...
> ***Замечание:** без разницы находитесь ли вы в мили зоне или у далеко у стены. В любом случае обстреливается целый
сектор.*

![пиупипипипиу](/img/ulduar/mimiron/Короткая очередь.gif)

- [Ракетный залп](https://www.wowhead.com/wotlk/ru/spell=63041) **(мгновенное)**: туррель выбирает случайного игрока и
...
![медленно ракеты уплывают вдаль, встречи с ними ты уже не жди](/img/ulduar/mimiron/Ракетный залп.gif)

- [Лазерный обстрел P3Wx2](https://www.wowhead.com/wotlk/ru/spell=63293) **(4 c. ---> потоковое 10 с.)**: туррели
...
![обстрел](/img/ulduar/mimiron/Обстрел.gif)

### Тактика 2-я фаза ###

> ***Замечание:** после первой фазы на полу ещё могут
оставаться [мины ближнего действия](https://www.wowhead.com/wotlk/ru/spell=63027), будте аккуратны.*

Туррель никуда не двигается, она всегда будет в центре. МДД и Танки могут всегда быть возле неё, ни от чего отбегать не
нужно. РДД и Хилам нужно равномерно распределится вокруг туррели, по окружности, и никуда не двигаться. Босс постоянно
будет применять [короткую очередь](https://www.wowhead.com/wotlk/ru/spell=64532) по направлении к случайному игроку. МДД
могут распределится как РДД, равномерно по окружности. Если очень хочется бить в спину, то будте любезны постоянно
бегать вокруг шайтан-машины (хилы вам даже спасибо могут сказать, будете получать чуть меньше урона). Ну вот примерный
план:

![plan kapkan?](/img/ulduar/mimiron/Плун туррель.png)
...
1. [Ракетный залп](https://www.wowhead.com/wotlk/ru/spell=63041): просто следите за красными метками на полу. Как раз
   ...
   Благо, есть не тольео красная зона но и видно вылет ракеты из-за спины туррели.
2. [Лазерный обстрел P3Wx2](https://www.wowhead.com/wotlk/ru/spell=63293): ДБМ предупредит об этой способности. МДД и
   Танкам легко быстро забежать за спину. РДД и Хилам даётся чуть меньше форы, но если все стоят недалеко от босса, то
...
> ***Замечание:** как-то при "прицельвании" перед [обстрелом](https://www.wowhead.com/wotlk/ru/spell=63293) босс как-то
...
Фаза весьма простая, лишь бы глаза были. После разрушения туррели Мимирон хвалится, что "всё так и задумано" и садится в
вертолёт.

### Третья фаза: "Воздушное судно" ###

![{tkbrjgnth](/img/ulduar/mimiron/Вертолёт.jpg)
...
него не дотягиваются. Желательно назначить какого-то РДД (лучше чернокнижника), котоырый сможет наагрить голову. У
...
![shar plazmi](/img/ulduar/mimiron/Шар плазмы.gif)
...
![bombot](/img/ulduar/mimiron/Призыв бомбота.gif)

Механизмы-адды появляются преимущественно из... круглых штук на полу, хз что это. Перед появлением из груглой фигни
...
![stolb](/img/ulduar/mimiron/Столб света.png)

Рассмотрим каждого робота:

|                                                                              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|:----------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Штурмовой робот**<br />![штурмовик](/img/ulduar/mimiron/Штурмовой бот.png) | **630 000** здоровья, бьёт с руки в среднем по 2000 <span className="dmg-phis">физическим</span> уроном в латы. Появляются из <span className="color-orange">оранжевых</span> порталов. <br /><br /> **<u>Способность:</u>** <br /><br /> -[Магнитное поле](https://www.wowhead.com/wotlk/ru/spell=64668) **(мгновенное ---> потоковое 6 с.)**: применяет к своей цели, накладывает магический дебафф. Обездвиживает игрока и увеличивает получаемый урон по на 30%. Весьма редко применяет. <br /><br /> С этого моба можно полутать [магнитное ядро](https://www.wowhead.com/wotlk/ru/item=46029). Эту фигню нужно использовать из инвентаря. Кидается как граната, весьма недалеко (не дальше чем 10 ярдов). <br /><br /> Этот робот является главным из всех, он появляется один примерно раз в 25 с. |
|    **Барахлобот**<br />![барахлобот](/img/ulduar/mimiron/Барахдобот.png)     | **189 000** здоровья, бьёт с руки в среднем по 1000 <span className="dmg-phis">физическим</span> уроном в латы. Появляется из <span className="dmg-nature">зелёных</span> порталов. <br /><br /> Этих маленьких ботов будет много, у них нет никаких способностей. Просто ещё одна маленькая проблема для така (или танков) на этой фазе.                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
лока может быть другим РДД, если есть охотник с [перенаправлением](https://www.wowhead.com/wotlk/ru/spell=34477). Данной
...
голову. Хилам на данной фазе можно отдохнуть, как на туррели тут хилить не нужно. Вот вам РДД танк, один-два
...
![план вертолёт](/img/ulduar/mimiron/Плун вертолёт.png)

Нужно решить, что делать с [бомботами](https://www.wowhead.com/wotlk/ru/spell=63811). Самым простым вариантом будет
...
издалека моба на себя. Пока бомба отвлечена на латника, РДД быстренько её сливают. Рискованно, но более профитно. При
таком подходе обязательно нужно применять хорошее замедление или стана, идеално
подходят [ледяной шока](https://www.wowhead.com/wotlk/ru/spell=49236)
или [ледяные оков](https://www.wowhead.com/wotlk/ru/spell=45524).

И самым главным моментом на данной фазе является спуск вертолёта на землю. С штурмовых роботов можно
полутать [магнитное ядро](https://www.wowhead.com/wotlk/ru/item=46029). Судя по ПТРу, лутать может каждый, вне
...
вертолётом. Игроку не нужно даже находится точно под ним. Летающая голова спускается и выходит из строя на 10 с. В это
...
собирает из трёх поверженных машин свой Щедевр.

### Четвёртая фаза: "V-07-TR-0N" ###

![shedevr](/img/ulduar/mimiron/Щедевррр.jpg)

Приготовьтесь сразится со всеми машинами сразу! Все эти простые три фазы слелись в одну, в которой замешаны большинство
...
здоровья. Загвоздка только есть: нужно разломать все составные части одновременно, иначе они полностью отхилятся:
...
Нижняя часть (корпус Левиафана) должна танковаться МТ. Средняя часть (туррель) не танкуется. Верхняя часть (голова)
...
- [Мины ближнего действия](https://www.wowhead.com/wotlk/ru/spell=63027) **(мгновенное)**: разбрасывает мины по
  ...
  наносит 12 000 урона от <span className="dmg-fire">огня</span> всем в радиусе 3 ярдов от мины. Применяте примерно каждые
  35 с.
...
- [Импульсный излучатель](https://www.wowhead.com/wotlk/ru/spell=64537) **(0,75 с.)**: основная спам-абилка
  туловища-туррели. Принцип действия немного схож со спам абилкой туррели на второй фазе. Поворачивается в сторону
  случайного игрока и пускает из рук пучок лазеров. Все, кто будет находится секторе, получат лазером на 6598 - 7402
  урона от <span className="dmg-arcane">тайной</span> магии.

- [Ракетный залп](https://www.wowhead.com/wotlk/ru/spell=63041) **(мгновенное)**: туррель выбирает двух случайных
...
![Вольтрон](/img/ulduar/mimiron/Способности Вольтрона.gif)
...
РДД и Хилам желательно расположить как на 2-й фазе, равномерно по кругу. МДД просто стоят в мили и бьют корпус
левиафана.
...
А, кстати. Есть же ещё РДД-танк. Нужно ли ему делть что-то особенное по позиционке? Ну, на первый взгляд нет. Надо
...
У хилов три задачи: отхиливать МТ, отхиливать РДД-танка и отхиливать оставшийся рейд
...
Бой начинается сразу же после нажатия кнопки. Процесс самоуничтожения завершится через 10 мин. Типо "энрейдж", если рейд
...
- [Огненный взрыв](https://www.wowhead.com/wotlk/ru/spell=76010) **(мгновенное)**: каждые 30 с. возле трёх случайных
  игроков происходит малеьнький взрыв. Он не дамажит, но на его месте появляется войд-зона, горящий огонь. В огне игроку
...
> ***Замечание:** взрывы будут происходить даже во время "затишья" между фазами, когда Мимирон будет некоторое время
тратить на представление очередного своего изобретения.*

![Bam bl](/img/ulduar/mimiron/Взрыв в гараже.gif)
...
![POZAAAR](/img/ulduar/mimiron/ПОЖААААр.gif)
...
![Podavitel](/img/ulduar/mimiron/Подавление пламени.gif)

- ***VX-001 Противопехотная пушка***: сразу две способности против огня. Первая -
  мини [подавитель пламени](https://www.wowhead.com/wotlk/ru/spell=65192) **(мгновенное)**. Туррель применяет на себя,
...
> ***Замечание:** "случайное" место на самом деле не случайное. Судя по всему туррель
> запускает [ледяную бомбу](https://www.wowhead.com/wotlk/ru/spell=64623) в одну из огненных луж. *

![ледяная бомба](/img/ulduar/mimiron/Ледяная бомба.gif)
...
- ***Вольтрон***: ему достаётся [ледяная бомба](https://www.wowhead.com/wotlk/ru/spell=64623) от туррели. Работает точно
  также, как на фазе с туррелью. Запускает каждые 30 с.

Как вы видите, абилки босса практически не изменились, добавилось лишь парочку. И что, "настолько этот огонь будет
мешать чт"да. Да да и ещё раз ДА! Вы либо сгорите от огня, не оставив место на арене. Либо огонь распространится так,
что не сможете убежать от ваншот способностей машин Мимирона. Всему рейду придётся в прямом смысле играть с огнём и
управлять распространением пожара. Если сильно-сильно попотеть (хе, неплохо провучало), то можно не дать распространится
...
1. **Рейду следует стоять недалеко от огня**: хоть это и звучит страшно, но так нужно делать. В таком случае новые
   ...
   эффективнее тушат сконцентрированный в одном большом месте пожар. На каждой фазе по разному нужно следовать даннному
   правилу.
...
![план1](/img/ulduar/mimiron/Хардмод_план1.png)

Левиафан примерно через 60 с. скастует [подавитель пламени](https://www.wowhead.com/wotlk/ru/spell=64570). Потушит
...
![план2](/img/ulduar/mimiron/Хардмод_план3.png)
...
сильно стеснят уход от ваншот-механики. Нужно дать им пространство для манёвра. Пачке РДД и Хилам нужно чуть сместится
...
![план4](/img/ulduar/mimiron/Хардмод_план4.png)

Если огонь заспавнился в милизоне, то РДД и Хилы рано или поздно упрутся в него. Нужно обойти, с краю (по жёлтой
...
огонь будет распространятся и будет появлятся новый. После каждой фазы всему рейду нужно встать в один кемп и идти по
границе пожарища. Так вы сконцентрируете весь огонь в одной части арены. Абилки босса отлично потушат бОльшую часть
пожара.

![План5](/img/ulduar/mimiron/Хардмод_план5.png)

<u>Вторая фаза</u>

МДД и Танки бегут к туррели и дамажат её. Может быть кто-то скажет "да зачем там танки, только лишний огонь заспавнят".
Но не всё так просто. Действительно, в милизоне увеличится шанс спавна пожара. Но туррель довольно часто будет его
...
стоять у ней чревато. Уменьшение скорости каста на 50%
...
![план6](/img/ulduar/mimiron/Хардмод_план6.png)

> ***Замечание:** скорее "совет". Если огонь заспавнится под таймер активации туррели, то есть смысл всем рейдом
...
Когда туррель войдёт в бой, то она тут же запустит [ледяную бомбу](https://www.wowhead.com/wotlk/ru/spell=64623) в
...
1. Если с прошлой фазы остались кучки огней, то нужно направить пачки РДД к ним, и плясать от них. Вспоминаем первое
...
2. МДД равномерно распределяются вокруг туррели, никто не заходит за спину (если это не классы, которым жизненно нужно
   ...
   туррели, конечно же. Но в таком варианте огня будет по минимуму. Страта немного рискованная и непросто осуществимая.
3. Можно по за 5 с. до пламени скомандовать рендж пачкам "Все в мили зону!" Тогда огонь 95% положится под турель, а она
...
импровизировать, играя с огнём. Кучненько его ложим, бомбы летят довольно часто, примерно каждые 45 с. Если постараться,
...
МТ хватает штурмовых ботов и барахлоботов, нужен РДД-танк для головы-вертолёта и нужно как-то расправлятся с бомботами (
ОТ, либо жёстко станить-замедлять). Типо так:

![план7](/img/ulduar/mimiron/Хардмод_план7.png)
...
Больше нечего добаваить по поводу 3-й фазы. Всё более-манее похоже на нормал, только с огнём не забываем играть. После
...
что [ледяная бомба](https://www.wowhead.com/wotlk/ru/spell=64623) туде не полетит потом. Если пожар не такой и большой,

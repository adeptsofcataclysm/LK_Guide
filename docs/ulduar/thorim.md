...
Когда Пантеон пал от рук Саргераса, осколки душ титанов устремились на Азерот, ищя в хранителях сосуды для остатков
своих сил. Все хранители на мгновение увидели воспоминания их создателей и почувствовали их присутствие. Сильнее всего
встревожился Локен, и Йог-Саррон вопсользовался этим. Локен нашёл утешение в супруге Торима, титаниде Сиф. Но чем больше
древний бог мучил разум хранителя, тем безумнее он становился. Сиф, встревоженная поведением Локена, потрабовала
...
отчяние, разбил своё молот с доспехами и ушёл из Ульдуара, став отшельником.

Игроки в Wotlk находят Торима на вершине самой высокой горы в Грозовой Гряде. С помошью Сынов Ходира, герои Азерота
...
остальные игроки прорываются по корридору к боссу на балкон.

Когда группа захвата лично встретится с хранителем, то тот воспримет это как вызов и сам примет участие в бою. Спрыгнет
...
корридора одного танка вполне достаточно (там не так много треша и новый не появляется), то можно на арену оставить ещё
...
![фаза0](/img/ulduar/thorim/2_фаза0.png)
...
5500 <span className="dmg-phis">физического</span> урона. Это прист, который хилит других аддов и дамажит игроков
светлой магией.
...
Ничего особенного. Один танк хватает червяка и отворачивает, второй танк старается забирать остальной трешь.
Дворфа-приста убиваем первым, контролим его станами и
...
Торим. Тогда они будут пускать молнии в относительно рядом стоящих игроков (зона поражения довольно большая). У Торима
на данной будут такие способности:
...
![молот бури](/img/ulduar/thorim/Молот бури.gif)
...
![столб](/img/ulduar/thorim/электрический столб.gif)

- [Берсерк](https://www.wowhead.com/wotlk/ru/spell=62560): Ториму наскучило! Наполняет всех аддов (на арене и в
  корридоре) могуществом. Урон увеличивается на 500%, скорость атаки и скорость произнесения заклинания на 200%,
...
- [Призыв искрящегося шара](https://www.wowhead.com/wotlk/ru/spell=62391): Торим что-то подозревает! Призывает
  искрящийся шар и пускает по корридору. Убивает всех игроков на своём пути. Торим применяет эту способность, если на
...
<u>Завоеватель клана тёмных рун</u> **(cпавнится каждые 15 c)**:**190 000** здоровья. Бьёт по танку от 7 200 до 9
...
- [Вихрь](https://www.wowhead.com/wotlk/ru/spell=15578) **(мгновенное --> потоковое 2 с.)**: начинает крутится на месте.
...
<u>Обыватели из клана Темных Рун</u> **(cпавнятся 6 штук каждые 20 с.)**: у каждого по **25 200** здоровья. Бьют по
...
- [Зуботычина](https://www.wowhead.com/wotlk/ru/spell=38313) **(мгновенный удар)**: может кикнуть каст, если игрок будет
...
- [Прокалывание](https://www.wowhead.com/wotlk/ru/spell=62418) **(мгновенный удар)**: применяет в танка. Бьёт на 11
  ...
  здоровья каждые 2 с. в течении минуты, или до исцеления более 90% от максимального запаса здоровья.
...
**Железный страж чести**: **169 429** здоровья. Бьёт по танку от 5600 до
7600 <span className="dmg-phis">физического</span> урона. Это милик скорее неприятный своими замедлениями и станами,
чем опасный.

- [Рассекающий удар](https://www.wowhead.com/wotlk/ru/spell=42724) **(заменяет слудующую тычку)**: обычный клив. Тем не
...
- [Подрезать сухожилия](https://www.wowhead.com/wotlk/ru/spell=48639) **(мгновенный удар)**: применяет в танка. Наносит
  от 2800 до 3800 <span className="dmg-phis">физического</span> урона и замедляет на 60% в теченьь 5 с.
...
![колоссс](/img/ulduar/thorim/4_Рунический_колосс.png)
...
![руки колосса](/img/ulduar/thorim/Руки колосса.gif)
...
- [Рывок](https://www.wowhead.com/wotlk/spell=62613) **(мгновенное действие)**: применяется к случайному игроку.
  Чарджится, ноносит от 4625 до 5375 <span className="dmg-phis">физического</span> урона жертве и отбрасывает назад.
...
![великан](/img/ulduar/thorim/5_древний_великан.png)

**808 860** здоровья. Бьёт по танку от 5 600 до 7 600 <span className="dmg-phis">физического</span> урона. Пока он жив,
...
![Великан](/img/ulduar/thorim/Взрыв руны.gif)
...
![Карта прохода](/img/ulduar/thorim/3_фаза1_проход.png)

### Фаза 2: способности Торима ###

Как только "группа звхвата" приблизится к хранителю, тот спрыгнет с балкона на арену. Собственно, теперь Торим вступает
...
![зап-зап](/img/ulduar/thorim/Цепная молния.gif)
...
![](/img/ulduar/thorim/Разряд молнии.gif)
...
и 18-17 ДД. Рычаг возле ворот открыввается очень медленно, и проход открыт только 8 с.

1. **Арена**: нужно 1-2 танка. Для арены нужно меньше хилов, чем для корридора, оставляем 2 из 5 (желательно оставить
   ...
   будут чувствовать себя получше других). Если есть прист ШП, то он
   ...
   центре, танки принимают на себя аддов, ДД их кливают, хилы хилят. Станы желательны, особенно в защитников (
...
![Фаза1](/img/ulduar/thorim/6_фаза1_арена.png)

2. **Коридор**: Нужен 1 танк. По нему будет проходить много урона
   ...
   из 5. Также даём ей как можно больше РДД. РДД нужны, чтоб не получать много урона от способносте второго
   ...
   и [обновления](https://www.wowhead.com/wotlk/ru/spell=62441). Теперь по прохождению корридора. Мобы не ресаются, для
   ...
   ловушку, если только не хотите прочитать забавное описание дебаффа от неё. Напоминаю карту корридора:

![проход](/img/ulduar/thorim/3_фаза1_проход.png)

Данная фаза не должна вызвать больших трудностей. Если на арене игроки захлёбываются в треше, то оставляем им ещё ДД. В
...
[Цепная молния](https://www.wowhead.com/wotlk/ru/spell=64390) легко шотнет рядомстоящих игроков. РДД и Хилы должы
...
![фаза2](/img/ulduar/thorim/7_фаза2.png)

У танков простая задача: менять друг друга
...
![Залп фростболтов](/img/ulduar/thorim/Залп фростболтов.gif)
...
![Кольцо льда](/img/ulduar/thorim/Кольцо льда.gif)
...
![Близард](/img/ulduar/thorim/Близард.gif)
...
![Хардмод](/img/ulduar/thorim/8_хардмод.png)
...
> ***Замечание:** для хардмода не грех будет рискнуть и оставить приста контролить завоевателя

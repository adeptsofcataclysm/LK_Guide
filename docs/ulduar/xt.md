...
![Vagon ebani](/img/ulduar/xt/Тёмная бомба.gif)
...
![tamdamdamdam](/img/ulduar/xt/Долбим фундамент.gif)
...
пачка РДД и Хилов немного подальше. Прежде всего рейду нужно договорится насчёт выноса
...
а светлую направо. Рейд может распологаться так:

![PlanRazrushitel](/img/ulduar/xt/Разрушитель_планрейда.png)
...
игроку будет наносится урон равный 10% от его максимального запаса здоровья. Способность действует 12 с. так что без
...
> ***Замечание:** урон по рейду можно уменьшить с помощью
...
![свет-тьма](/img/ulduar/xt/Свет-тьма-свет-тьма-свет-тьма.gif)
...
Самых жирных, утрамбовщиков, забирают(ет) ОТ. Подводят к МДД и убивают. Ещё я читал, что этих аддов нужно просто держать
...
с. Допустим у нас 1 МТ, 1 ОТ и 5 хиллеров. Остаётся 18 ДД, каждому нужно держать ДПС около 18 500 чтоб переввести. Число
...
15%. Переходки исчезают (сердце то уже разбито), следовательно адды тоже перестают спавнится. Это упрощает бой. Однако
...
- [Опаляющий свет](https://www.wowhead.com/wotlk/ru/spell=65121): в месте, где с человека спал дебафф, появляется
  моб [искра жизни](https://www.wowhead.com/ru/npc=34004). Этот маленький шарик с **352 000** здоровья имеет только одну
...
![Искра жизни](/img/ulduar/xt/Искра жизни.gif)
...
Челу с [светлым дебаффом](https://www.wowhead.com/wotlk/ru/spell=65121) следует не просто убежать влево, как в нормал
...
![plaaaaan](/img/ulduar/xt/Фаза2_план.png)
...
прожать [сакру](https://www.wowhead.com/wotlk/ru/spell=64205), это снизит получаемый урон на 20% по ВСЕМУ рейду на 6 с.
что весьма мощно.
...
под [раскатами ярости](https://www.wowhead.com/wotlk/ru/spell=62776).Самая неочевидная среальная ложность - убить босса

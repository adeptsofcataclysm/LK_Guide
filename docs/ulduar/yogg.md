...
Йогг-Саррон с помощью Локена изменил Кузню воли, в которой создавались каменнокожие 
...
это хардмод. "Убийство без хранителей" и "Убийство с хранителем" отличается отделным достижением и летающим
...
![Бросок валанира](/img/ulduar/yogg/В рот мне молот.gif)
...
У [заготовки](https://www.wowhead.com/wotlk/ru/item=45896) 20 с. кд, можно применить ещё раз в случае провала. Теперь,
...
Освобождённые хранители, если с ними поговорить. Tелепортируются на пъедесталы на арене с боссом и будут помогать в бою.
...
![луч дестабилизации](/img/ulduar/yogg/Матрица дестабилизации.gif)
...
![колодец зелёнки](/img/ulduar/yogg/Колодец здравомыслия.gif)
...
Йогг-Саррона они не могут поднять руку на беззащитную девушку. Она союзник, правило "карсное - бить, зелёное - хилить"
...
В течении всей фазы на арене будут крутится зелёные пары. Из них будут спавнится стражи. Чем дольше бой, тем быстрее они
спавнятся. Я заметил, что первые 4 стража появляются с интервалом в 15 с. следующие 4 с интервалом 10 с. скорее всего
дальше так и будет. 9, 10, 11 и 12 стражи будут спавнится каждые 5 с. но этого не должно происходить. Потому
что [кольцо тьмы](https://www.wowhead.com/wotlk/ru/spell=62714) наносит примерно 1/8 здоровья Сарочек. Задача рейда -
убивать стражей Йогг-Саррона около Сары и не сдохнуть от взрывов самому.

Мобы появляются только из зелёненьких тучек, которые медленно кружат вокруг Сары. Двигаются строго по окружности.

![движение облаков](/img/ulduar/yogg/Хоровод зелёных паров.gif)
...
![план1фаза1](/img/ulduar/yogg/Фаза1_план1.png)

Оставшиеся МДД пускай идут к танку. Должна быть
...
значениях щдоровья адда танк должен отвести того к Сарочке. Нужно назначить несколько РДД, которые будут убивать стражей
...
![план2фаза1](/img/ulduar/yogg/Фаза1_план2.png)

Самым главным недостатком первой стратегии является урон по МДД. Как ни крути, а урон может не уйти в резист и кто-то
...
Сарочка превращается из в валь'киру (скорее это просто визуальная черта, никакого лора тут нет). Её всё ещё нельзя бить.
...
![Психоз](/img/ulduar/yogg/Психоз.gif)
...
- [Душевная болезнь](https://www.wowhead.com/wotlk/ru/spell=63830) **(1,5 с.)**: применяется к случайной цели. Наносит
  ...
  радиусе 10 ярдов от предыдущей жертвы (тоже нанесётся урон,
...
![Душевная болезнь](/img/ulduar/yogg/Душевная болезнь.gif)
...
![схожее мышление](/img/ulduar/yogg/Схожее мышление.gif)
...
![Луч смерти](/img/ulduar/yogg/Луч смерти.gif)

Рейду нужно добить оставшихся Стражей, и уйти с центра в одну из частей арены. Дрежаться следует вместе, чтобы не
...
![Порталы](/img/ulduar/yogg/Порталы в безумие.gif)
...
|                                                 |                                                  |
|:-----------------------------------------------:|:------------------------------------------------:|
| ![Взгляд1](/img/ulduar/yogg/Взгляд безумца.gif) | ![Взгляд2](/img/ulduar/yogg/Взгляд безумца2.gif) |

Внутри видения будут находится жёлтые нейтральные НПС. Но это обманка! На самом деле это Чувствительные Щупальца,
мимикрирующие под окружение. Например, в видение драконов будут такие трапы:

![Драконы иллюзии](/img/ulduar/yogg/Драконы-иллюзии.gif)

У них по **40 000** здоровья. Щупальца остаются нейтральным даже после нанесения урона, они никак не атакуют. Но имеют
способность [беспощадное отражение](https://www.wowhead.com/wotlk/ru/spell=63305). Атакующему будет наносится урон
от <span className="dmg-shadow">тьмы</span> в размере 60% от нанесённого урона. Легко отъехать от такого рефлект
урона, будте аккуратны.
...
|:------------------------------------------------------------:|:-------------------------------------------:|:-------------------------------------------------:|
|         ![Шторм](/img/ulduar/yogg/Видение_Шторм.png)         |  ![ЦЛК](/img/ulduar/yogg/Видение_ЦЛК.png)   | ![драконий](/img/ulduar/yogg/Видение_драконы.png) |

После убийства всех тентаклей одна из стенок в видении пропадает. Открывается проход к Мозгу Йогг-Саррона (ктати
...
тех-кто-сверху, можно без напряга разобраться сщупальцами. Но бесконечно бить мозг не получится по одной причине.
Смотрите, как только Йогг-Саррон открвает портал, то мозг начинает
...
![Выход](/img/ulduar/yogg/Выход из мозга через портал.gif)
...
Оно может появится в любой части карты. Оно самое жирное и настакивает на
...
> ***Замечание:** кливы, [правосудия](https://www.wowhead.com/wotlk/ru/spell=20271), не прерывают
...
как можно быстрее встретится. Если в человека
...
> ***Замечание:** [душевную болезнь](https://www.wowhead.com/wotlk/ru/spell=63830) нужно
...
него могут войти только 10 человек. Перед боем нужно определить в эту группу минимум 2 хила, желательно одного ханта а
всё остальное забить ДД. Большую часть должны составлять МДД, т.к. оставшиеся РДД наверху смогут дамажить все щупальца.

![порталы в видение](/img/ulduar/yogg/Порталы в безумие.gif)
...
![доджим черепки](/img/ulduar/yogg/Взгляд безумца2.gif)
...
больше урона по нему. Для этого и нужен хант с [духом стаи](https://www.wowhead.com/wotlk/ru/spell=13159). Её нужно
включить **ПОСЛЕ** убийства всех щупалец в видении.
Когда [доведение до помешательства](https://www.wowhead.com/wotlk/ru/spell=64059) будет докастовываться, то не забудте
выйти из мозга.
...
Здаровья у тела Йогг-Сарона опускается до 30% от максимума. Это будет **13 199 779** единиц ХП. Бить он не начнёт, так и
останется большоё тушой мяса. Щупальца перестают спавнится, но старые остаются. Появляются следующие способности
Йогг-Сарона:
...
Это основная способность данной фазы. Чёрный смеющийся черепок над Йогг-Сароном появляетс каждые 12-15 с. и существует 4
...
Я их опишу для полноты картины. Итак, каждые 30 с. Йогг-Сарон будет бафать живых бессмертных стражей. Выбираются мобы с
наименьшим кол-вом здоровья (скорее всего это будут мобы с 1 хп). Перед баффом на избранных мобов появлятся зелёная
...
![гифка моба с меткой](/img/ulduar/yogg/Маяк тени.gif)
...
![Отхил](/img/ulduar/yogg/Абилки бессмертных стражей.gif)
...
столько, чтобы бессмертный страж умирал до отхила и появления нового моба. Вполне может случится по таймингам так,
...
![расстановка 3-й фазы](/img/ulduar/yogg/Фаза3_план.png)
...
Каждые 10 с. танку нужно ловить бессмертного стража и подводить к пачке миликов. За 10 с. нужно снести мобу 424 000
...
с запасом, не "вот по рассчётам эти ДД выдадут чуть больше 42к ДПСа так что хватит". Рейду будет
...
вроде как нестрашно. Ну и идут много мобов, что с того? Один фиг ДД сливают их сдоровье и урон по танку не такой
...
следующем касте пометятся 5 стражей. К тому моменту рейд настакает 10 мобов. Даже если рейду удастся как-то вывести 5
...
Нужно её пройти как можно быстрее. рРейд постоянно теряет [здравомыслие](https://www.wowhead.com/wotlk/ru/spell=63050)
...
можно быстрее разобраться с щупальцами и пойти долбить мозг. Наверху людям нужно не мешкаться, постоянно бить щупальца.
Без Мимирона щупальце-дебаффер (разлагающее) будет пулемётной очерелью плеваться в рейд своими приколами. Контрольте,
...
В принципе, всё как в нормалмоде, но только ДД по стражам нужно выделить поболее из-за отстутствия большинства баффов
...
Без [владением](https://www.wowhead.com/wotlk/ru/spell=31821) обойтись можно, но будте готовы. Танку без хила придётся
